...
contract HecoPunks {
    ...
    string public standard = 'HecoPunks';
    string public name;
    ...
    function hecoPunks() payable {
        //        balanceOf[msg.sender] = initialSupply;              // Give the creator all initial tokens
        owner = msg.sender;
        totalSupply = 10000;                        // Update total supply
        punksRemainingToAssign = totalSupply;
        name = "HECOPUNKS";                         // Set the name for display purposes
        symbol = "TP";                              // Set the symbol for display purposes
    ...
    function buyPunk(uint punkIndex) payable {
        ...
        if (msg.value < offer.minValue) throw;      // Didn't send enough TRX
